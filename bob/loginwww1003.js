...
function confirm_submit() {
	if ($('enctp').value == 1) {
		...
		if (level3_frame.thirdAction()) {
			try {
			$('level3_frame').contentWindow.document.getElementById('url').value = $('url').value;
			} catch (e){}
...
function useLevel(levelno) {
	...
	if (chglevel == 3) {
		$('upw').value = "";
		$('level3_frame').src = "/loginv2/activex.nhn?111013";
	} else if (chglevel == 2) {
		$('upw').value = "";
...
function setLevelImg(lv) {
	if (lv==1) {
		...
		$('lv1_img').src='http://static.naver.com/green/v2/img/btn_security1_on.gif';
		$('lv2_img').src='http://static.naver.com/green/v2/img/btn_security2_off.gif';
		$('lv3_img').src='http://static.naver.com/green/v2/img/btn_security3_off.gif';
	} else if (lv==2) {
		$('slide_btn1').className ='level1';
		$('slide_btn2').className ='level2 level_on';
		$('slide_btn3').className ='level3';
		$('lv1_img').src='http://static.naver.com/green/v2/img/btn_security1_off.gif';
		$('lv2_img').src='http://static.naver.com/green/v2/img/btn_security2_on.gif';
		$('lv3_img').src='http://static.naver.com/green/v2/img/btn_security3_off.gif';
    } else if (lv==3) {
		$('slide_btn1').className ='level1';
		$('slide_btn2').className ='level2';
		...
		$('lv1_img').src='http://static.naver.com/green/v2/img/btn_security1_off.gif';
		$('lv2_img').src='http://static.naver.com/green/v2/img/btn_security2_off.gif';
		$('lv3_img').src='http://static.naver.com/green/v2/img/btn_security3_on.gif';
    } else {
		$('slide_btn1').className ='level1';
		$('slide_btn2').className ='level2 level_on';
		$('slide_btn3').className ='level3';
...
function checkAd(flags) {
	...
	if (!onError) {
		if ((flags == '1' || flags == 1)
			...
			$('level_img1').src = 'http://static.naver.com/green/v2/img/h_security' + initEnc + '_txt.gif';
		} else {
			addshow=false;
			if (swapLevel == 2) {
				if (navigator.userAgent.indexOf("Opera") != -1 || navigator.userAgent.indexOf("Safari") != -1 || (navigator.userAgent.indexOf("Safari") != -1 && navigator.platform.indexOf("Mac") != -1 )) {
			...
			$('level_img1').src = 'http://static.naver.com/green/v2/img/h_security1_txt.gif';
			swapLevel = -1;
			hideElement("m1");
			try {
				//$('upw').disabled=false;
...
if ((navigator.appVersion.indexOf("MSIE 9") != -1))
	...
	idHeight = "20";
	idMaxChars = "25";
	idTextDefault = "http://static.naver.net/common/login/bg_login_id_main_6.gif";
	idTextFont = "돋움";
	idBoldTag = ""; // true
	idTextColor = "444444";
	idTextSize = "12";
...
if ((navigator.appVersion.indexOf("MSIE 9") != -1))
	...
	pwHeight = "20";
	pwMaxChars = "16";
	pwTextDefault = "http://static.naver.net/common/login/bg_login_pw_main_6.gif";
	pwTextFont = "돋움";
	pwBoldTag = ""; // true
	pwTextColor = "444444";
	pwTextSize = "12";
